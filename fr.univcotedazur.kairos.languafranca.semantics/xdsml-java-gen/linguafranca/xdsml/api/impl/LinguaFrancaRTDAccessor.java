...
public class LinguaFrancaRTDAccessor {
  ...
  public static java.lang.Integer getcurrentMicroStep(EObject eObject) {
		return new java.lang.Integer((java.lang.Integer)  getAspectProperty(eObject, "fr.univcotedazur.kairos.languafranca.semantics.LinguaFranca", "fr.univcotedazur.kairos.languafranca.semantics.k3dsa.ModelAspect", "currentMicroStep"));
	}
	public static boolean setcurrentMicroStep(EObject eObject, java.lang.Integer newValue) {
		return setAspectProperty(eObject, "fr.univcotedazur.kairos.languafranca.semantics.LinguaFranca", "fr.univcotedazur.kairos.languafranca.semantics.k3dsa.ModelAspect", "currentMicroStep", new java.lang.Integer(newValue));
	}

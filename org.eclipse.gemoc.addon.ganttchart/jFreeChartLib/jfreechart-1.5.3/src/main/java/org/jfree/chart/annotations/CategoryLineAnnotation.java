...
public class CategoryLineAnnotation extends AbstractAnnotation 
    ...
    public void draw(Graphics2D g2, CategoryPlot plot, Rectangle2D dataArea,
        ...
        g2.fill(createArrowHead(lineX1, lineY1, lineX2, lineY2, 30, 20));
    }

    
    private static Shape createArrowHead(double lineX1, double lineY1, double lineX2, double lineY2, double length, double width)
    {
        double x0 = lineX1;
        double y0 = lineY1;
        double x1 = lineX2;

...
import linguafranca.xdsml.api.impl.LinguaFrancaModelStateHelper.AttributeNameToValue;
...
public class LinguaFrancaRTDAccessor {
  ...
  public static java.lang.String getlfGroovyFunctions(EObject eObject) {
		return new java.lang.String((java.lang.String)  getAspectProperty(eObject, "fr.univcotedazur.kairos.linguafranca.semantics.LinguaFranca", "fr.univcotedazur.kairos.linguafranca.semantics.k3dsa.ReactionAspect", "lfGroovyFunctions"));
	}
	public static boolean setlfGroovyFunctions(EObject eObject, java.lang.String newValue) {
		return setAspectProperty(eObject, "fr.univcotedazur.kairos.linguafranca.semantics.LinguaFranca", "fr.univcotedazur.kairos.linguafranca.semantics.k3dsa.ReactionAspect", "lfGroovyFunctions", new java.lang.String(newValue));
	}
  public static java.lang.Integer getcurrentValue(EObject eObject) {
	...
	public static boolean setcurrentValue(EObject eObject, java.lang.Integer newValue) {
		Integer theValue = newValue == null ? null: new java.lang.Integer(newValue);
